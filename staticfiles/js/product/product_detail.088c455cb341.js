$('#similar_items').on('slide.bs.carousel', function (e) {
  ...
  */
  ...
  var idx = $e.index();
  var itemsPerSlide = 5;
  var totalItems = $('.carousel-item-similar').length;
  ...
  if (idx >= totalItems-(itemsPerSlide-1)) {
      ...
      for (var i=0; i<it; i++) {
          ...
          if (e.direction=="left") {
              $('.carousel-item-similar').eq(i).appendTo('.carousel-inner-similar');
          }
          else {
              $('.carousel-item-similar').eq(0).appendTo('.carousel-inner-similar');
          }
      }
  }
});
...
$('#more-images-slide').on('slide.bs.carousel', function (e) {
  ...
  */
  ...
  var idx = $e.index();
  var itemsPerSlide = 1;
  var totalItems = $('.carousel-item-image').length;
  ...
  if (idx >= totalItems-(itemsPerSlide-1)) {
      ...
      for (var i=0; i<it; i++) {
          // append slides to end
          if (e.direction=="left") {
              $('.carousel-item-image').eq(i).appendTo('.carousel-inner-image');
          }
          else {
              $('.carousel-item-image').eq(0).appendTo('.carousel-inner-image');
          }
      }
  }
});
