  ...
  */
  ...
  if (idx >= totalItems-(itemsPerSlide-1)) {
      ...
      for (var i=0; i<it; i++) {
          ...
          if (e.direction=="left") {
              $('.carousel-item-similar').eq(i).appendTo('.carousel-inner');
          }
          else {
              $('.carousel-item-similar').eq(0).appendTo('.carousel-inner');
          }
      }
  }
});
  ...
  */
  ...
  if (idx >= totalItems-(itemsPerSlide-1)) {
      ...
      for (var i=0; i<it; i++) {
          // append slides to end
          if (e.direction=="left") {
              $('.carousel-item-image').eq(i).appendTo('.carousel-inner');
          }
          else {
              $('.carousel-item-image').eq(0).appendTo('.carousel-inner');
          }
      }
  }
});
